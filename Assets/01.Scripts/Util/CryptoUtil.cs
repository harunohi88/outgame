...
public class CryptoUtil
{
    ...
    {
        // 입력된 평문을 해시화한 후, 기존의 해시값과 비교한다.
        string hashedInput = Encryption(plainText, salt);
        return hashedInput.Equals(hashedText, System.StringComparison.OrdinalIgnoreCase);
    }
}
